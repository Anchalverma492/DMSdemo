...
public class PicassoDemo extends AppCompatActivity implements View.OnClickListener {
    ImageView imageView;
    int i = 0;
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.btnPlaceholder:
                    Picasso.with(this).load("https://i.imgur.com/tGbaZCY.jpg").placeholder(R.drawable.ic_remark).into(imageView);
                    break;
                case R.id.btnUrl:
                    Picasso.with(this).load("https://i.imgur.com/tGbaZCY.jpg")
                            .placeholder(R.drawable.ic_remark).into(imageView);
                    break;
                case R.id.btnError:
                    Picasso.with(this).load("https://i.imgur.com/tGbaZCY.jpg").placeholder(R.drawable.ic_remark).error(R.drawable.ic_onhandnew).into(imageView);
                    break;
                case R.id.btnCallBack:
                    Picasso.with(this).load("https://i.imgur.com/tGbaZCY.jpg").error(R.mipmap.ic_launcher).into(imageView, new Callback() {
                        @Override
                    ...
                    break;
                case R.id.btnResize:
                    Picasso.with(this).load(R.drawable.ic_remark).resize(200, 200).into(imageView);
                    break;
                case R.id.btnRotate:
                    Picasso.with(this).load(R.drawable.ic_remark).rotate(90f).into(imageView);
                    break;
                case R.id.btnScale:
                    ...
                    if (i == 3)
                        ...
                        if (i == 0) {
                            Picasso.with(this).load(R.drawable.ic_remark).fit().into(imageView);
                            Toast.makeText(getApplicationContext(), "Fit", Toast.LENGTH_SHORT).show();
                        } else if (i == 1) {
                            Picasso.with(this).load(R.drawable.ic_remark).resize(200, 200).centerCrop().into(imageView);
                            Toast.makeText(getApplicationContext(), "Center Crop", Toast.LENGTH_SHORT).show();
                        } else if (i == 2) {
                            Picasso.with(this).load(R.drawable.ic_remark).resize(200, 200).centerInside().into(imageView);
                ...
                case R.id.btnTarget:
                    Picasso.with(this).load("https://cdn.journaldev.com/wp-content/uploads/2017/01/android-constraint-layout-sdk-tool-install.png")
                            .placeholder(R.drawable.ic_remark).error(R.drawable.ic_onhandnew).into(target);
                    break;
            }
        }
